...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?r 23. kwi 12:48:50 2014
# Project:  polcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile polcoin-qt.pro
#############################################################################
...
Makefile: polcoin-qt.pro  ../../Qt/4.8.5/mkspecs/default/qmake.conf ../../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile polcoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/temp/polcoin_1.2.0/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/temp/polcoin_1.2.0/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/temp/polcoin_1.2.0/src/leveldb/libleveldb.a: FORCE
